...
- 智能体Agent
  - 了解Agent
    ...
    - 深入理解clouade code源码： [Github](https://sawzhang.github.io/deep-dive-claude-code/index.html)  
  - Agent简单实现
...
- RAG
  ...
  - Agentic RAG 阅读材料
    ...
    - Is Grep All You Need? How Agent Harnesses Reshape Agentic Search【202605】: [Paper](https://arxiv.org/abs/2605.15184)  
- DeepSearch
